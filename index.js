...
app.use((req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Origin', 'https://frolicking-sorbet-e4b2eb.netlify.app','http://localhost:3000');
...
// app.use(
//     cors({
//       origin: "https://frolicking-sorbet-e4b2eb.netlify.app/",
//     })
//   );
